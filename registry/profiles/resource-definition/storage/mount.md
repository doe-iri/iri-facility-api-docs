# IRI Filesystem Mount Resource Definition Profile

**Profile URI:** `https://iri.science/profiles/resource-definition/storage/mount`  
**Base Profile:** `https://iri.science/profiles/status/resource`  
**Resource Type:** `urn:doe-iri:resource:storage:mount`  
**Status:** Draft  
**Version:** 1.0.0
...
`urn:doe-iri:resource:storage:mount` and MUST be used together with the

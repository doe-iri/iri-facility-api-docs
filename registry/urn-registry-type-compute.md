...
| [`iri:has-cpu`](./relations/has-cpu.md) | Compute Node | CPU | `0..*` | Static | Yes | Indicates that the compute node contains or provides the identified CPU resource. |
| [`iri:has-gpu`](./relations/has-gpu.md) | Compute Node | GPU | `0..*` | Static | Yes | Indicates that the compute node contains or provides the identified GPU resource. |
